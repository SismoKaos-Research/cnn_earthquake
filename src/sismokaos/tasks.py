...
`sismokaos.model.registry` answers the other half, which architectures a task
...
TASKS = {t.key: t for t in (
    ...
    Task("detect", "detect", "sismokaos.detection.cnn_lstm_classify",
