...
Usage:
    python3 src/sismokaos/forecasting/chaos_config_sweep.py \\
        --parquet ~/Projects/Sismokaos/sismokaos-cli/dataset_features_chaos_q1_5hz/bodt_q1_chaos_5hz_features.parquet \\
...
from sismokaos.forecasting.chaos_dataset import (ID_COLUMNS, RADIUS_KM, MIN_MAGNITUDE,
