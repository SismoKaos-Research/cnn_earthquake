...
**Checkpoint filenames are untouched.** `sismokaos.checkpoints` matches
...
def _build_dual_channel(branch, p, shapes):
    ...
    from sismokaos.model.dual_channel import (DualChannelDualHeadNet,
                                              DualChannelNet)
...
def _build_se_resnet(branch, p, shapes):
    ...
    from sismokaos.model.trunk2d import SETrunk2D
...
def _build_sequence_head(branch, p, shapes):
    ...
    if branch == "raw-hour":
        from sismokaos.waveform import RawWaveformEncoder
        enc = RawWaveformEncoder(out_dim=p["encoder_dim"], dropout=p["dropout"])
    else:
        from sismokaos.waveform import NativeWaveformEncoder
...
def _build_gru(branch, p, shapes):
    """ForecastGRU."""
    from sismokaos.model.recurrent import ForecastGRU
...
def _build_tcn(branch, p, shapes):
    ...
    from sismokaos.model.tcn import ForecastTCN
...
def _build_day_3class(branch, p, shapes):
    """DayCNNLSTM3Class."""
    from sismokaos.forecasting.cnn_lstm_daily_3class import DayCNNLSTM3Class
...
def _build_multiweek(branch, p, shapes):
    ...
    from sismokaos.forecasting.cnn_lstm_lstm_multiweek import HierarchicalCNNLSTMLSTM
...
def _build_gru_cnn_fusion(branch, p, shapes):
    ...
    from sismokaos.forecasting.gru_cnn import SeismicFusionModel
...
def _build_catalog_waveform_fusion(branch, p, shapes):
    ...
    from sismokaos.forecasting.cnn_lstm_catalog_waveform_fusion import (CATALOG_DIM,
...
ARCHITECTURES = (
    Architecture(
        ...
        source="sismokaos.model.dual_channel:DualChannelNet",
    ...
    Architecture(
        ...
        source="sismokaos.model.trunk2d:SETrunk2D",
    ...
    Architecture(
        ...
        source="sismokaos.model.sequence:SequenceHeadNet",
    ...
    Architecture(
        ...
        inputs="seq (B,T,F)",
        source="sismokaos.model.recurrent:ForecastGRU",
        build=_build_gru,
        params=(
    ...
    Architecture(
        ...
        inputs="seq (B,T,F)",
        source="sismokaos.model.tcn:ForecastTCN",
        build=_build_tcn,
        params=(
    ...
    Architecture(
        ...
        source="sismokaos.forecasting.cnn_proximity_classify:CNNProximityClassifier",
    ...
    Architecture(
        ...
        source="sismokaos.forecasting.cnn_lstm_daily_3class:DayCNNLSTM3Class",
    ...
    Architecture(
        ...
        source="sismokaos.forecasting.cnn_lstm_lstm_multiweek:HierarchicalCNNLSTMLSTM",
    ...
    Architecture(
        ...
        source="sismokaos.forecasting.gru_cnn:SeismicFusionModel",
    ...
    Architecture(
        ...
        source=("sismokaos.forecasting.cnn_lstm_catalog_waveform_fusion:"
                "CatalogWaveformFusionNet"),
