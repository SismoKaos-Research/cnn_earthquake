...
Arrivals are predicted rather than picked (`seismic_cli/src/arrival_from_catalog.py`).
...
| Training | `src/sismokaos/detection/cnn_lstm_classify.py --channels 2d --batch-size 32 --ensemble-seeds 42,43,44` |
| Cross-corpus evaluation | `src/sismokaos/detection/evaluate_cross_corpus.py` |
