...
Everything those four define is re-exported here, so `from seismolib.continuous
...
torch and the detection package, and `from seismolib.continuous import
...
from seismolib.continuous.association import (background_and_guards, load_snr,
                                              predicted_arrivals)
from seismolib.continuous.chunks import (COMPONENT_ROLES, add_chunk_args,
                                         clean_block, component_segments,
                                         make_windows, pick_components,
                                         read_chunk, taper_vector)
from seismolib.continuous.spans import (clip_spans, common_spans,
